...
const NavigationLink = styled(UnstyledLink)`
    ...
    color: ${props => (props.location.pathname === props.to || props.location.pathname === props.to + "/") ? ({ theme }) => theme.colours.deepBlue:({ theme }) => theme.colours.white};
    font-weight: ${props => (props.location.pathname === props.to || props.location.pathname === props.to + "/") ? ({ theme }) => theme.fontWeight.bold :({ theme }) => theme.fontWeight.regular};
